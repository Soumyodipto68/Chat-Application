...
const SignupPage = () => {
  return (
    <div className="min-h-screen flex items-center justify-center">
      <div className="rounded-2xl shadow-2xl p-8 w-full max-w-md bg-linear-to-r from-blue-500 to-cyan-800 relative overflow-hidden">
          ...
          <form className="space-y-5">
            <div>
              ...
              <input
                id="username"
                type="text"
                className="w-full px-4 py-3 bg-gray-700 text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400 transition"
