...
const SignupPage = () => {
  return (
    <div className="min-h-screen flex items-center justify-center">
      <div className="rounded-2xl shadow-2xl p-8 w-full max-w-md bg-slate-300 relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <form className="space-y-5">
            ...
            <button
              type="submit"
              className="w-full px-4 py-3 bg-gradient-to-r from-blue-700 to-blue-900 text-white font-semibold rounded-lg shadow-md hover:from-blue-600 hover:to-purple-600 transition transform hover:scale-105"
            >
              Sign Up
            </button>
          </form>
